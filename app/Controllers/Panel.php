...
define ('__RUTA_PLUGINS', 'http://localhost/SSSIFANBW');
...
class Panel extends Controller {
	...
	*/
	...
	// 	return view("menu/beneficiario/fideicomitente");
	// }
	...
	// 	return view("menu/beneficiario/beneficiario", $data);
	// }

	// public function asociarcuenta(){
	// 	return view("menu/beneficiario/cuentabancaria");
	// }

	// public function reporte(){
	// 	$this->load->model('beneficiario/MComponente');
	// 	$data['componente'] = $this->MComponente->listarTodo();
	// 	return view("menu/beneficiario/reporte", $data);
	// }

	// public function actualizar(){
	// 	return view("menu/beneficiario/actualizarbeneficiario");
	// }

	// public function finiquitos(){
	// 	return view("menu/beneficiario/finiquito");
	// }
	// public function historialsueldo(){
	// 	return view("relaciondesueldo");
	// }

	// public function sueldolote(){
	// 	return view('sueldolote');
	// }

	// public function ordenpago(){
	// 	return view("menu/orden_pago/orden");
	// }

	// public function ordenpagoejecutada(){
	// 	return view("menu/orden_pago/ejecutada");
	// }

	// public function consultarmovimiento(){
	// 	return view("menu/beneficiario/consultarmovimiento");
	// }
	...
	// 	return view("menu/beneficiario/medidajudicial", $data);
	// }
	
	// public function anticipo(){
	// 	$this->load->model('beneficiario/MAnticipo');
	// 	$data['lst'] = $this->MAnticipo->listarTodo();
	// 	return view("menu/beneficiario/anticipo", $data);
	// }
	...
	// 	$data['componente'] = $this->MComponente->listarTodo();
	// 	return view("menu/calculos/directiva", $data);
	// }
	...
	// 	return view("menu/calculos/tasabcv", $data);
	// }
	...
	// 	return view("menu/calculos/interesescaidos");
	// }

	// public function interessemestral(){
	// 	return view("menu/calculos/interessemestral");
	// }

	// public function calcinitereses(){
	// 	return view("menu/calculos/calcinitereses");
	// }
	// public function reclamos(){
	// 	return view("menu/reclamos/reclamos");
	// }
	// public function administrar(){
	// 	$this->load->model("usuario/Usuario");
	// 	$data['usuarios'] = $this->Usuario->listar();
	// 	return view("menu/administracion/administrar", $data);
	// }
	// public function auditoria(){

	// 	return view("menu/administracion/reporteauditoria");
	// }
	...
	// 	return view("menu/otros/calculadoraspace");
	// }

	// public function pruebatxt(){
	// 	return view("menu/pruebatxt");
	// }
	...
	// 	return view('reporte/beneficiario/hoja_vida', $data);
	// }
	...
	// 	$data['Beneficiario'] = $this->MBeneficiario;
	// 	$data['codigo'] = $cod;
	// 	return view('reporte/beneficiario/carta_banco', $data);
	// }
	...
	// 	$data['codigo'] = $cod;
	// 	return view('reporte/beneficiario/carta_banco_fallecido', $data);
	// }
	...
	// 	$data['Beneficiario'] = $this->MBeneficiario;
	// 	$data['codigo'] = $cod;
	// 	return view('reporte/beneficiario/medida_judicial_ejecutada', $data);
	// }
	...
	// 	return view('reporte/beneficiario/asignacion_menos_diez', $data);
	// }
	...
	// 	$data['motivo'] = $motivo;
	// 	$data['lst'] = $this->MBeneficiario->detalleMovimientoFamiliar($cedula, $codigo);
	// 	return view('reporte/beneficiario/asignacion_fsas', $data);
	// }
	...
	// 	$data['lst'] = $this->MBeneficiario->detalleMovimientoFamiliar($cedula, $codigo);
	// 	return view('reporte/beneficiario/causa_muerte', $data);
	// }
	...
	// 	$data['Beneficiario'] = $this->MBeneficiario;
	// 	$data['lst'] = $this->MBeneficiario->detalleMovimientoFamiliar($cedula, $codigo);
	// 	return view('reporte/beneficiario/memorandum_fas', $data);
	...
	// 	$data['Beneficiario'] = $this->MBeneficiario;
	// 	$data['lst'] = $this->MBeneficiario->detalleMovimientoFamiliar($cedula, $codigo);
	// 	return view('reporte/beneficiario/diferencia_asignacion', $data);
	...
	// 	$data['Beneficiario'] = $this->MBeneficiario;
	// 	$data['codigo'] = $codigo;
	// 	return view('reporte/beneficiario/punto_cuenta_anticipo', $data);
	// }
	...
	// 	return view('reporte/beneficiario/reporte_anticipos', $data);
	// }
	...
	// 	return view('reporte/beneficiario/carta_anticipos_finanzas', $data);
	// }
	...
	// 	return view('reporte/beneficiario/medida_judicial', $data);
	// }
	...
	// 	return view('menu/beneficiario/registrar_finiquito', $data);
	// }
	...
	function obtenerMenu(){
		header('Content-Type: application/json');
		$perfil = new Perfil();
		return print_r($perfil->listarMenu($_SESSION['usuario']['id']));
		//print_r();	
	}
